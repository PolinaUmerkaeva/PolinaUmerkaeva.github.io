...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://63985c0dfe03352a94cdeafd.mockapi.io/tyrs')
            const cartData = await axios.get('https://63985c0dfe03352a94cdeafd.mockapi.io/cart')
            const favoritesData = await axios.get('https://63985c0dfe03352a94cdeafd.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://63985c0dfe03352a94cdeafd.mockapi.io/cart/${id}`)
